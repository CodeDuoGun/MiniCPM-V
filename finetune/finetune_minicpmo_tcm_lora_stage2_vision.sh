...
DATA="${DATA:-$PROJECT_DIR/outputs/medical_sft_minicpmo_vision/tcm_consult_minicpmo_vision_train.json}"
EVAL_DATA="${EVAL_DATA:-$PROJECT_DIR/outputs/medical_sft_minicpmo_vision/tcm_consult_minicpmo_vision_val.json}"
